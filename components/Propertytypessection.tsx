...
const propertyTypes = [
  {
    ...
    accent: "#274b97",
    accentLight: "#7a9ed4",
    borderColor: "border-[#274b97]/20",
    shadowColor: "rgba(39,75,151,0.15)",
  },
  {
    id: 2,
    title: "عمائر",
    ...
    accent: "#1f3d7a",
    accentLight: "#5b82c4",
    borderColor: "border-[#1f3d7a]/20",
    shadowColor: "rgba(31,61,122,0.15)",
  },
  {
    id: 3,
    title: "شقق تمليك",
  ...
  },
  {
    ...
    accent: "#1f6b45",
    accentLight: "#34a870",
    borderColor: "border-[#1f6b45]/20",
    shadowColor: "rgba(31,107,69,0.15)",
  },
  {
    id: 5,
    title: "أراضي خام",
    ...
    accent: "#8a5e1a",
    accentLight: "#c4984a",
    borderColor: "border-[#8a5e1a]/20",
    shadowColor: "rgba(138,94,26,0.15)",
  },
  {
    id: 6,
    title: "أخرى",
    ...
    accent: "#5a2d8a",
    accentLight: "#a47ad4",
    borderColor: "border-[#5a2d8a]/20",
    shadowColor: "rgba(90,45,138,0.15)",
  },
];
...
const PropertyTypesSection = () => {
  ...
  return (
    <section
      dir="rtl"
      className={`${cairo.className} relative w-full py-24 bg-[#f0f4fb] overflow-hidden`}
    >
      {/* ══ مجسمات الخلفية ══ */}
          ...
          return (
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  background: `linear-gradient(to left, ${item.accentLight}, ${item.accent})`,
                }}
              />
              ...
              <motion.div
                ...
                style={{
                  background: isHovered
                    ? `linear-gradient(135deg, ${item.accent}18, ${item.accentLight}22)`
                    : `${item.accent}0d`,
                  color: item.accent,
