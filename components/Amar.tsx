  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden" dir="rtl">
      ...
      <div className={`${cairo.className} relative z-10 flex flex-col justify-end min-h-screen pb-12 px-6 sm:px-12 md:px-20`}>
        ...
        {/* عنوان السكشن */}
        <div className="mb-10">
          <span className="text-white/40 text-xs tracking-[0.4em] font-light mb-3 block">02</span>
          ...
          <p className="text-white/75 text-base sm:text-lg leading-relaxed max-w-xl mb-6">
            نوفر عمائر سكنية وتجارية متكاملة في أرقى أحياء الطائف، مصممة لتلبية متطلبات
            الاستثمار والسكن معاً. فرص عقارية مميزة بعوائد استثمارية مضمونة وموقع استراتيجي.
          </p>
        ...
        {offers && offers.length > 0 && (
          <div>
            ...
            <div className="flex flex-wrap gap-5 pb-4">
              {offers.map((offer) => {
                const isRent = offer.status === "للإيجار";
                return (
                  <motion.div
                    key={offer._id}
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between gap-3 pt-3 border-t border-white/10">
                        <div>
                          <p className="text-white/40 text-[10px]">{isRent ? "الإيجار" : "المطلوب"}</p>
