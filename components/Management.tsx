...
const Management = () => {
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8" dir="rtl">
        ...
        <div className="flex max-md:flex-col-reverse gap-8 lg:gap-12 items-center">
          ...
          >
            <h3 className={`${cairo.className} text-xl sm:text-2xl md:text-3xl font-bold text-gray-800`}>
              <span className="text-[#274b97]">إدارة</span> الأملاك باحترافية
            </h3>
            
            <p className={`${cairo.className} text-gray-600 leading-relaxed text-sm sm:text-base md:text-lg`}>
              نقدم في <span className="text-[#274b97] font-semibold">مؤسسة بوابة الطائف العقارية</span> خدمات متكاملة لإدارة الأملاك تشمل متابعة 
