  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden" dir="rtl">
      ...
      <div className={`${cairo.className} relative z-10 flex flex-col justify-end min-h-screen pb-12 px-6 sm:px-12 md:px-20`}>
        ...
        {/* عنوان السكشن */}
        <div className="mb-10">
          <span className="text-white/40 text-xs tracking-[0.4em] font-light mb-3 block">01</span>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between gap-3 pt-3 border-t border-white/10">
                      <div>
                        ...
                        {offer.priceNote && (
                          <p className="text-white/30 text-[9px]">{offer.priceNote}</p>
                        )}
                      </div>
                      <a
