...
const offers = [
  {
    ...
    type: "image",
    media: "/img3.jpeg",
    title: "٣ قطع تجارية بصك واحد",
    location: "العرفاء ٢ — شمال الطائف",
    details: [
      { label: "المساحة الكلية", value: "٤٥,٠٠٠م²" },
      { label: "الشارع الشرقي", value: "عرض ٥٠م × طول ٢٢٥م" },
      { label: "الشارع الجنوبي", value: "عرض ١٠٠م × طول ٢٠٠م" },
    ],
    status: "للبيع",
    description: "٣ قطع تجارية بصك واحد — فرصة استثمارية مميزة",
  },
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between gap-3 pt-3 border-t border-white/10">
                      <div>
                        ...
                        <p className="text-white text-lg font-black">حسب الطلب</p>
                      </div>
                      <a
